"use strict";module.export({default:()=>WindowSettings});var join;module.link('path',{join(v){join=v}},0);var assignIn;module.link('lodash/assignIn',{default(v){assignIn=v}},1);/* eslint-disable no-param-reassign */
