"use strict";var module1=module;module1.export({default:()=>App});var electron;module1.link('electron',{default(v){electron=v}},0);var Events;module1.link('events',{EventEmitter(v){Events=v}},1);var path;module1.link('path',{default(v){path=v}},2);var fs;module1.link('fs-plus',{default(v){fs=v}},3);var shell;module1.link('shelljs',{default(v){shell=v}},4);var assignIn;module1.link('lodash/assignIn',{default(v){assignIn=v}},5);var Module;module1.link('./modules/module',{default(v){Module=v}},6);var LoggerManager;module1.link('./loggerManager',{default(v){LoggerManager=v}},7);var DesktopPathResolver;module1.link('./desktopPathResolver',{default(v){DesktopPathResolver=v}},8);var WindowSettings;module1.link('./windowSettings',{default(v){WindowSettings=v}},9);var Squirrel;module1.link('./squirrel',{default(v){Squirrel=v}},10);/* eslint-disable import/no-unresolved,no-console */
