"use strict";var module1=module;module1.export({default:()=>DesktopPathResolver});var path,join;module1.link('path',{default(v){path=v},join(v){join=v}},0);var fs;module1.link('fs',{default(v){fs=v}},1);
