"use strict";module.export({default:()=>StorageMigration});var app;module.link('electron',{app(v){app=v}},0);var path;module.link('path',{default(v){path=v}},1);var findNewestFileOrDirectory,removePaths,rimrafPromisfied,ioOperationWithRetries,batchIoOperationWithRetries;module.link('./storageMigration/ioHelper',{findNewestFileOrDirectory(v){findNewestFileOrDirectory=v},removePaths(v){removePaths=v},rimrafPromisfied(v){rimrafPromisfied=v},ioOperationWithRetries(v){ioOperationWithRetries=v},batchIoOperationWithRetries(v){batchIoOperationWithRetries=v}},2);
