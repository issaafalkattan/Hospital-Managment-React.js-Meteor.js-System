"use strict";var module1=module;module1.export({default:()=>LocalServer});var http;module1.link('http',{default(v){http=v}},0);var connect;module1.link('connect',{default(v){connect=v}},1);var findPort;module1.link('find-port',{default(v){findPort=v}},2);var enableDestroy;module1.link('server-destroy',{default(v){enableDestroy=v}},3);var url;module1.link('url',{default(v){url=v}},4);var path;module1.link('path',{default(v){path=v}},5);var fs;module1.link('fs-plus',{default(v){fs=v}},6);var send;module1.link('send',{default(v){send=v}},7);var mime;module1.link('mime',{default(v){mime=v}},8);
